...
<html>
	...
	<body style="background-image: url('../resources/image/photo12');">
		포토 게시판
		<hr/>
	...
	<table style="width:600px">
		<tr>
			<td>
				<c:forEach var="photoBoard" items="${list}">                              <!-- showPhoto?savedfile=${photoBoard.savedfile}를써서 그림데이터를 받아온다. -->
		...
		<div style="width: 600px;font-family:돋움;font-size:30px;">
